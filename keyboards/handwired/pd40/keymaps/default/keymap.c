...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
       ...
       KC_LCTL, KC_LALT,MO(MOUSE), KC_LGUI,MO(LEFT), KC_SPC,  KC_SPC,MO(RIGHT), KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT
    ),

    [LEFT] = LAYOUT(
        KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, _______,
       _______, XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX,  KC_EQL, KC_MINS, KC_LBRC, KC_RBRC, KC_BSLS,  KC_ENT,
    ...
    [MOUSE] = LAYOUT(
       ...
       _______, _______, _______, XXXXXXX, _______, XXXXXXX, XXXXXXX, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R
    )
};
